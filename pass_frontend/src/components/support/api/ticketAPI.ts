...
let MOCK_TICKETS: TicketData[] = [
  {
    ...
    description: "O sistema está retornando erro ao tentar gerar relatórios financeiros em formato PDF. O erro ocorre especificamente na seção de totais.",
    category: "Bug",
    module: "Financeiro",
    environment: "WEB",
  ...
  },
  {
    ...
    description: "Cliente solicita criação de novo usuário para acessar o sistema administrativo. Necessário configurar permissões básicas de visualização.",
  ...
  },
  {
    ...
    description: "Durante o processo de checkout, a API está retornando erro interno do servidor (500). O problema ocorre na validação dos dados de pagamento.",
    category: "Bug",
    module: "Financeiro",
    environment: "WEB",
  ...
  },
  {
    ...
    description: "Cliente tem dúvidas sobre como configurar a integração com o gateway de pagamento. Precisa de documentação e exemplos de implementação.",
  ...
  },
  {
    ...
    description: "O botão principal da página inicial precisa ter a cor ajustada para seguir o padrão da identidade visual da empresa.",
    category: "Ajuste/Melhoria",
    module: "Treinamentos",
    environment: "WEB",
